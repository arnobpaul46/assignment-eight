              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <Link
                    ...
                    className="p-1 md:p-3 bg-blue-500/10 text-blue-500 rounded-xl hover:bg-blue-500 hover:text-white transition-all"
                  >
                  ...
                  <button
                    ...
                    className="p-1 md:p-3 bg-red-500/10 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-all"
                  >
