    ...
    return (
        <div className="bg-[#111827] border border-white/10 rounded-3xl p-4 transition-all duration-300 hover:border-blue-500/50 group shadow-xl">
            ...
            <div className="flex items-center justify-between">
                <Link href={`/all-courses/${course?.id}`}><button className="px-5 py-2 rounded-xl bg-white/5 border border-white/10 text-blue-400 hover:bg-blue-600 hover:text-white transition-all text-xs font-bold hover:cursor-pointer">
                    Learn More
                </button></Link>
